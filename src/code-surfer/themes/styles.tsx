...
function StylesProvider({ theme = {}, children }: { theme?: CodeSurferTheme; children: React.ReactNode }) {
...
const Styled = {
  ...
  Code: (props: HTMLProps<HTMLElement>) => <code {...props} sx={useStyles().code} />,
  Pre: React.forwardRef((props: HTMLProps<HTMLPreElement>, ref: React.Ref<HTMLPreElement>) => (
    <pre {...props} sx={usePreStyle()} ref={ref} />
  )),
  Title: (props: HTMLProps<HTMLHeadingElement>) => <h4 {...props} sx={{ ...baseTitle, ...useStyles().title }} />,
  Subtitle: (props: HTMLProps<HTMLParagraphElement>) => <p {...props} sx={{ ...baseSubtitle, ...useStyles().subtitle }} />,
}
